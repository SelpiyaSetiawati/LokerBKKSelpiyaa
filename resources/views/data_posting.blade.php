                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <a href="{{url('form_posting')}}"><button class="btn btn-primary ">Tambah Data</button></a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="posting/delete/{{$item -> id}}" class="fas fa-trash-alt"></a>
                                                    <a href="posting/edit/{{$item -> id}}"class="fas fa-edit"></a>
                                                  </td>
                                            </tr>
                                            @endforeach
